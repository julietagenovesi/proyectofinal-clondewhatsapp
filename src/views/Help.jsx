  ...
  return (
    <main className="help">
      <section>
        ...
        <p>
          ¡Bienvenido/a a Clon de WhatsApp!
          Una aplicación diseñada para chatear con amigos, familiares o compañeros. Te permite enviar y recibir mensajes en tiempo real, manteniendo conversaciones fluidas desde cualquier dispositivo.
        </p>
      </section>
